...
def apply_bdry_conditions(var_list, rhs_list, dt):
    ...
    Pi00_rbdry = Pi00_rbdry - (-paragamma2/2 * rhs_g00 + 1/2*rhs_Pi00 - b/2 * rhs_Phi00)*dt
    Pi01_rbdry = Pi01_rbdry - (-paragamma2/2 * rhs_g01 + 1/2*rhs_Pi01 - b/2 * rhs_Phi01)*dt
    Pi11_rbdry = Pi11_rbdry - (-paragamma2/2 * rhs_g11 + 1/2*rhs_Pi11 - b/2 * rhs_Phi11)*dt

    Phi00_rbdry = Phi00_rbdry - (paragamma2/(2*b) * rhs_g00 - 1/(2*b)*rhs_Pi00 + 1/2 * rhs_Phi00)*dt
    Phi01_rbdry = Phi01_rbdry - (paragamma2/(2*b) * rhs_g01 - 1/(2*b)*rhs_Pi01 + 1/2 * rhs_Phi01)*dt
    Phi11_rbdry = Phi11_rbdry - (paragamma2/(2*b) * rhs_g11 - 1/(2*b)*rhs_Pi11 + 1/2 * rhs_Phi11)*dt
    ...
    Pi00_lbdry = Pi00_lbdry - (-0.5*paragamma2 * rhs_g00 + 0.5*rhs_Pi00 + b/2 * rhs_Phi00)*dt
    Pi01_lbdry = Pi01_lbdry - (-0.5*paragamma2 * rhs_g01 + 0.5*rhs_Pi01 + b/2 * rhs_Phi01)*dt
    Pi11_lbdry = Pi11_lbdry - (-0.5*paragamma2 * rhs_g11 + 0.5*rhs_Pi11 + b/2 * rhs_Phi11)*dt

    Phi00_lbdry = Phi00_lbdry - (-paragamma2/(2*b) * rhs_g00 + 1/(2*b)*rhs_Pi00 + 0.5*rhs_Phi00)*dt
    Phi01_lbdry = Phi01_lbdry - (-paragamma2/(2*b) * rhs_g01 + 1/(2*b)*rhs_Pi01 + 0.5*rhs_Phi01)*dt
    Phi11_lbdry = Phi11_lbdry - (-paragamma2/(2*b) * rhs_g11 + 1/(2*b)*rhs_Pi11 + 0.5*rhs_Phi11)*dt
