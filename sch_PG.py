...
def get_exact_var_list(func_space):
    ...
    g01_exp = Expression("pow(2/x[0], 0.5)", degree=10)
    g11_exp = Expression("1", degree=10)
    
    Pi00_exp = Expression("-2/pow(x[0],2)*pow(2/x[0], 0.5)", degree=10)
    Pi01_exp = Expression("-1/pow(x[0],2)", degree=10)
    Pi11_exp = Expression("0", degree=10)
    
    Phi00_exp = Expression("-2/pow(x[0],2)", degree=10)
    Phi01_exp = Expression("-pow(1/(2*x[0]), 0.5)/x[0]", degree=10)
    Phi11_exp = Expression("0.0", degree=10)
...
def get_H_list(func_space):
    H0_exp = Expression("pow(1/(2*x[0]),0.5)*1/x[0]*(2+x[0])/x[0]", degree=10)
    H1_exp = Expression("1/x[0]*(1+2*x[0])/x[0]", degree=10)
...
def get_deriH_list(func_space):
    ...
    deriH10_exp = Expression("-2*pow(2, 0.5)*(10+3*x[0])/(8*pow(1/x[0], 1.5)*pow(x[0], 5))", degree=10)
    deriH11_exp = Expression("-2*(x[0]+1)/pow(x[0], 3)", degree=10)
